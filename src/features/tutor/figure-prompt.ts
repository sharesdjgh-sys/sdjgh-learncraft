...
- 실제 통계·사건·지리 정보는 제공된 자료로 확인할 수 있을 때만 사용합니다. 직접 만든 수치는 가상 자료로 명시하고 실제 기관명이나 출처를 꾸며내지 않습니다. 실제 지도는 learncraft-visual의 map 형식을 사용합니다. 별도의 기후·역사 지도 자료가 필요한데 확보되지 않았으면 분포나 경계를 추측하지 말고 한계를 밝힙니다.
