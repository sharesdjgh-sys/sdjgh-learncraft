...
const imageSlot = z.object({ kind: z.literal("image-slot"), ...base, id: z.string().uuid(), aspectRatio: z.enum(["4:3", "1:1"]), stage: z.enum(["image_generating", "image_processing", "image_reviewing", "image_revising", "image_failed"]) });
